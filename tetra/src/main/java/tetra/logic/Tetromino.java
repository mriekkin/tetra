...
public enum Tetromino {
    ...
    J(new int[]{0x8E00, 0x6440, 0x0E20, 0x44C0}, 0),
    L(new int[]{0x2E00, 0x4460, 0x0E80, 0xC440}, 0),
    O(new int[]{0xCC00, 0xCC00, 0xCC00, 0xCC00}, 0),
    S(new int[]{0x6C00, 0x4620, 0x06C0, 0x8C40}, 0),
    T(new int[]{0x4C40, 0x4E00, 0x4640, 0x0E40}, 0),
    Z(new int[]{0xC600, 0x2640, 0x0C60, 0x4C80}, 0);
